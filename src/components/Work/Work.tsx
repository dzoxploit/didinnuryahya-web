            ...
            <div className="row item">
              <div className="twelve columns">
                <div>
                  <h3>Shipper</h3>
                  <p className="info">
                    Test Automation Engineer Intern<span>&bull;</span>{" "}
        ...
        >
          <div className="nine columns main-col">
            <div className="row item">
              <div className="twelve columns">
                <div>
                  <h3>PT MNC OTT Network - Vision+</h3>
                  <p className="info">
                    QA Engineer Intern<span>&bull;</span>{" "}
                    <em className="date">Jan 2022 - March 2022</em>
                  </p>
                  <p>
        ...
        >
          <div className="nine columns main-col">
            <div className="row item">
              <div className="twelve columns">
                <div>
                  <h3>PT Prawiranegara Bahagia Selalu (Heylawedu.id)</h3>
                  <p className="info">
                    Backend Engineer Part-time<span>&bull;</span>{" "}
            ...
            <div className="row item">
              <div className="twelve columns">
                <div>
                  <h3>Bangbeli.com</h3>
                  <p className="info">
                    Backend Developer Intern<span>&bull;</span>{" "}
        ...
        >
          <div className="nine columns main-col">
            <div className="row item">
              <div className="twelve columns">
                <div>
                  <h3>PT Lintas Telematika Nusantara</h3>
                  <p className="info">
                    Backend engineer Part-time<span>&bull;</span>{" "}
                    <em className="date">June 2020 - August 2020</em>
                  </p>
                  <p>
            ...
            <div className="row item">
              <div className="twelve columns">
                <div>
                  ...
                  <p className="info">
                    Software Engineer Freelance<span>&bull;</span>{" "}
